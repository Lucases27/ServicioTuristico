    ...
    <section id="faq" class="faq section-bg">
            ...
            <div class="col-12">
                    <div class="table-responsive">
                                ...
                                <tbody>
                                    <% 
                                     ...
                                     for (Cliente cli : lista) {
                                        String fechaNac = new SimpleDateFormat("yyyy/MM/dd").format(cli.getFecha_nac());
                                       %><tr>
                                        ...
                                        <td><%=cli.getEmail()%></td>
                                        <td><%=fechaNac%></td>
                                        <td><a class="btn btn-outline-primary btn-sm"  href="SvClientes?modificar=<%=cli.getId_cliente()%>">Modificar</a></td>
		                 	<td><a class="btn btn-outline-primary btn-sm"  href="SvClientes?eliminar=<%=cli.getId_cliente()%>">Eliminar</a></td>
                                        <%
                                         }
                                    %>
                                </tbody>
                            ...
                            <div class="mt-3">
                                    <a class="btn btn-primary btn-sm " href="SvClientes">Volver</a>
                            </div>
                    </div>
            </div>
    </section>
