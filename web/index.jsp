		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-xl-7 col-lg-6 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5">
					...
					<p>
						El objetivo de esta aplicaci�n es simplificar la actividad de la recepci�n y administraci�n de turnos para ambos modelos de usuario, mediante la modalidad a distancia (Online).
					</p>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 d-flex ">
						<div class="icon-box">
							...
							<h4>Cl�nica general</h4>
							<p >Consultas m�dicas.<br>Desparacitaciones.<br>Vacunaciones.<br>Entre otros.</p>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 d-flex ">
						<div class="icon-box">
					...
					<div class="col-lg-4 col-md-6 d-flex ">
						<div class="icon-box">
							...
							<p>Derivaciones.<br>Hospitalizaci�n.<br>Certificados para viajes.</p>
						</div>
					</div>
				</div>
			</div> 
